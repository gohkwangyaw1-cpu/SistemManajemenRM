        ...
        <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
            <div className="max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3.5">
                    ...
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-[#BA1B1D] to-[#E63946] flex items-center justify-center text-white shadow-md shadow-red-900/10">
                        <Hospital className="w-6 h-6" />
                    </div>
                    <div>
                        <div className="flex items-center gap-2">
                            <span className="font-extrabold text-lg tracking-tight text-[#BA1B1D] font-['Outfit']">
                                RS AWAL BROS
                            </span>
